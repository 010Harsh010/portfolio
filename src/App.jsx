...
const App = () => {
        ...
        fromTo: (elements, from, to, options = {}) => {
          ...
          els.forEach((el, index) => {
            ...
            Object.assign(el.style, {
              ...
              transform: `translateY(${from.y || 0}px) translateX(${
                from.x || 0
              }px) scale(${from.scale || 1}) rotate(${from.rotation || 0}deg)`,
              transition: `all ${options.duration || 1}s ${
                options.ease || "cubic-bezier(0.23, 1, 0.32, 1)"
              }`,
            });
            ...
            setTimeout(() => {
              Object.assign(el.style, {
                ...
                transform: `translateY(${to.y || 0}px) translateX(${
                  to.x || 0
                }px) scale(${to.scale || 1}) rotate(${to.rotation || 0}deg)`,
              });
            }, delay * 1000);
          });
        },
  ...
  const projects = [
    {
      ...
      description:
        "Full-stack video streaming platform with OAuth authentication, live streaming capabilities, and hybrid recommendation system using TF-IDF and collaborative filtering.",
      year: "2024",
      image: "stream.jpg",
    ...
    },
    {
      ...
      description:
        "Travel helper powered by Graph Neural Networks and Reinforcement Learning for optimized path prediction with real-time traffic analysis.",
      year: "2025",
    ...
    },
    {
      ...
      description:
        "Real-time ride-booking application with live updates, driver-passenger communication, and integrated payment processing.",
      year: "2024",
      image: "Uber.jpg",
  ...
  const skillIcons = {
    ...
    C: (
      ...
      >
        <polygon
          points="64,4 8,32 8,96 64,124 120,96 120,32 64,4"
          fill="none"
        />
        <path d="M84 48a28 28 0 1 0 0 32" fill="none" />
      </svg>
    ),
    R: (
      <svg
    ...
    PyTorch: <img src="pytorch.svg" alt="PyTorch" width="24" height="24" />,
    ...
    OOPs: (
      <img
        src="https://img.icons8.com/?size=100&id=_pdyeJRmgjVF&format=png&color=000000"
        alt="OOPS"
        className="w-5 h-5"
      />
    ),
    "Computer Networks": (
      <img
        src="https://img.icons8.com/?size=100&id=3vPtpomlM6YA&format=png&color=000000"
    ...
    DBMS: (
      <img
        src="https://img.icons8.com/?size=100&id=B0vuqxJA1C0b&format=png&color=000000"
        alt="DBMS"
        className="w-5 h-5"
      />
    ),
    "Data Analytics": (
      <img
        src="https://img.icons8.com/?size=100&id=rWi0LaiOnwiH&format=png&color=000000"
        alt="Data Analytics"
        className="w-5 h-5"
      />
    ),
 ...
 const skills = [
  ...
  },
  {
    ...
    items: ["MongoDB", "MySQL", "Redis", "Neo4j", "Prisma", "FAISS", "ChromaDB"],
  },
  {
  ...
  {
    category: "Tools & Developer Workflow",
    items: ["Git", "Docker", "Postman", "Vite", "Hugging Face", "Google Maps API"],
  },

  {
    category: "Other",
    items: ["Blender", "MongoDB Atlas"],
  },
];
  ...
  return (
    <div
      ref={scrollRef}
      className="hide-scrollbar bg-white text-gray-900 overflow-x-hidden"
    >
      {/* Navigation */}
      <nav className="header fixed top-0 w-full z-50 border-b border-gray-100 transition-all duration-500">
        <div className="max-w-6xl mx-auto px-8 py-6">
          <div className="flex justify-between items-center">
            <div className="text-xl flex flex-row gap-5 align-middle font-light tracking-wide">
              <img src="image.png" alt="" height={24} width={24} />
              <a
                href=""
                className="hover:text-gray-600 transition-colors text-2xl duration-300"
              >
                Harsh Singh
              </a>
            </div>
        ...
        <div className="max-w-4xl text-center relative z-10">
          <h1 className="hero-title text-5xl md:text-7xl font-light leading-tight mb-8 tracking-tight">
            {titleWords.map((word, index) => (
              <span
                key={word}
                className="inline-block opacity-0 mr-4"
          ...
          <div className="hero-location mt-12 flex items-center justify-center space-x-6 text-gray-500 opacity-0">
            <div className="flex items-center space-x-2">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.google.com/maps?sca_esv=c2df872898b90107&biw=1536&bih=776&output=search&q=bhiwadi&source=lnms&fbs=AIIjpHxCtmkhHKu27CW9pNYJlh4RoZZ_y8scaivnpjp3a9aEstvyzM9WArA0Q4B52rAVe2Sa6zFfiAm8cYa8nfYhOqjaGPs97G_EEy9Tt64nlu2xgJyH7djRPh1Zp4ZyU7slLZJkkl8osrh_3de-FunqNJbi4EoV5I2Eqn4_4eq239ycLLY4F9tiWRzrPEXFMal72TFfbTKm5Y5M7xLma77fv-6n-dHK1rbLNNK3mmEDDwXMVu01E-g&entry=mc&ved=1t:200715&ictx=111"
              >
                Alwar, Rajasthan
              </a>
            </div>
            ...
            <div className="md:col-span-8 animate-on-scroll opacity-0 transform translate-y-16 transition-all duration-1000 ease-out delay-200">
              <div className="prose prose-lg max-w-none">
                <p className="text-2xl leading-relaxed font-light text-gray-700 mb-12">
                  ...
                  Science at Indian Institute of Information Technology Sricity,
                  with a focus on creating innovative solutions that bridge
                  theoretical AI concepts with practical applications.
                </p>

                <div className="grid md:grid-cols-2 gap-16 mt-20">
                  <div>
                    <h3 className="text-xl font-light mb-8 text-gray-900">
                      Education
                    </h3>
                    <div className="space-y-3">
                      <div className="text-gray-700 flex text-lg">
                        <img
                      ...
                      <div className="text-gray-500">2023-2027 • CGPA 7.88</div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-gray-500">Leetcode Rating: 1500+</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="work" className="py-32 px-8 relative">
        ...
        <div className="progress-line-container hidden md:block absolute left-8 top-32 bottom-32 opacity-0 transition-opacity duration-500">
          <div className="relative h-full">
            ...
            {/* Progress line */}
            <div
              className="progress-line absolute left-1/2 transform -translate-x-1/2 w-px bg-gray-400 transition-all duration-300 ease-out"
              style={{ height: "0%" }}
            ></div>

            {/* Moving indicator */}
            <div
              className="progress-indicator absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-gray-600 rounded-full transition-all duration-300 ease-out shadow-sm"
              style={{ top: "0%" }}
            >
        ...
        <div className="max-w-6xl mx-auto">
          <div onClick={()=>navigate("/portfolio/projects")} className="mb-24 cursor-pointer animate-on-scroll opacity-0 transform translate-y-12 transition-all duration-1000 ease-out flex items-center gap-3">
                ...
                <div className="grid md:grid-cols-12 gap-8 items-start relative z-10">
                  ...
                  <div className="md:col-span-6">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-3xl md:text-4xl font-light mb-3 group-hover:text-gray-600 transition-all duration-500 cursor-pointer"
                    >
                      {project.title}
                    </a>
                  ...
                  <div className="md:col-span-3 flex justify-end">
                    ...
                    <div className="hidden md:block relative">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="absolute top-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:bg-white transition-all duration-500"
                      >
...
<section id="responsibility" className="py-32 px-8">
  <div className="max-w-6xl mx-auto">
    <div className="grid md:grid-cols-12 gap-16">
      <div className="md:col-span-4 animate-on-scroll opacity-0 transform translate-y-12 transition-all duration-1000 ease-out">
        <h2 className="text-sm uppercase tracking-widest text-gray-500 mb-8">
      ...
      <div className="md:col-span-8 animate-on-scroll opacity-0 transform translate-y-16 transition-all duration-1000 ease-out delay-200">
        <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 hover:border-gray-200 transition-all duration-500">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8">
            <div>
              <h3 className="text-2xl font-light text-gray-900 mb-2">
                AI/ML Lead — IOTA Technical Club
              </h3>
          ...
          <div className="space-y-4 text-gray-700 font-light text-lg leading-relaxed">
            <div className="flex gap-3">
              ...
              <span>
                Mentoring juniors on building production-ready projects using
                React, Node.js, and ML/DL pipelines.
              </span>
            </div>
            ...
            <div className="flex gap-3">
              <span className="text-gray-400">∗</span>
              <span>
                Co-organizing hackathons, tech events, and innovation challenges
                with faculty and the core team.
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="md:col-span-8 animate-on-scroll opacity-0 transform translate-y-16 transition-all duration-1000 ease-out delay-200">
              <div className="mb-16">
                <p className="text-2xl leading-relaxed font-light text-gray-700">
                  ...
                  innovative projects in AI, machine learning, and full-stack
                  development.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 stagger-children">
                <div className="space-y-6 stagger-item opacity-0 transform translate-y-8 transition-all duration-1000 ease-out">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-4 text-gray-600 text-lg"
                  >
                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center">
                      <img
                        src="https://img.icons8.com/?size=100&id=B4gLcc0hbLj9&format=png&color=000000"
                        alt="Resume"
                        className="w-5 h-5"
                      />
                    </div>
                ...
                <div className="space-y-6 stagger-item opacity-0 transform translate-y-8 transition-all duration-1000 ease-out">
                  <a
                    href="https://www.linkedin.com/in/harsh-singh-66916a350/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-4 text-gray-700 hover:text-gray-900 transition-colors duration-300 group text-lg"
                  >
                  ...
                  <a
                    href="https://github.com/010Harsh010"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-4 text-gray-700 hover:text-gray-900 transition-colors duration-300 group text-lg"
                  >
                  ...
                  <a
                    href="https://leetcode.com/u/harsh_singh_01/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-4 text-gray-700 hover:text-gray-900 transition-colors duration-300 group text-lg"
                  >
                    ...
                    <span className="group-hover:underline">LeetCode</span>
                  </a>
                  <a
                    href="https://codeforces.com/profile/Demolition007"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-4 text-gray-700 hover:text-gray-900 transition-colors duration-300 group text-lg"
                  >
                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-gray-200 transition-colors duration-300">
                      ...
                      >
                        <path
                          fill="#F44336"
                          d="M23.25,18.875V12c0-0.759-0.672-1.375-1.5-1.375h-3c-0.828,0-1.5,0.616-1.5,1.375v6.875c0,0.759,0.672,1.375,1.5,1.375h3C22.578,20.25,23.25,19.634,23.25,18.875z"
                        ></path>
                        <path
                          fill="#2196F3"
                          d="M13.5,20.25c0.828,0,1.5-0.616,1.5-1.375V5.125c0-0.759-0.672-1.375-1.5-1.375h-3C9.673,3.75,9,4.366,9,5.125v13.75c0,0.759,0.673,1.375,1.5,1.375H13.5z"
                        ></path>
                        <path
                          fill="#FFC107"
                          d="M0.75,18.875c0,0.759,0.673,1.375,1.5,1.375h3c0.828,0,1.5-0.616,1.5-1.375V9.25c0-0.759-0.672-1.375-1.5-1.375h-3c-0.827,0-1.5,0.616-1.5,1.375V18.875z"
                        ></path>
                    ...
                    <span className="group-hover:underline">CodeForces</span>
                  </a>
                </div>
              </div>
            </div>
